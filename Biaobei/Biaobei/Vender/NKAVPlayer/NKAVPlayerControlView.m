...
- (void)closeButtonDidClick{
    if (_delegate && [_delegate respondsToSelector:@selector(closeDidClickBolck)]) {
        [_delegate closeDidClickBolck];
    }
}
- (UILabel *)timeLabel
{
...
- (void)layoutSubviews
{
    ...
    self.timeLabel.frame = CGRectMake(CGRectGetMinX(self.fullScreenButton.frame) - 80, self.playButton.frame.origin.y, 60+ 20, CGRectGetHeight(self.timeLabel.bounds));
